...
DEFAULT_INPUT_PATH = SUBMISSION_ROOT / "data" / "processed" / "pubchem_train_test_pools.pkl"
DEFAULT_OUTPUT_PATH = SUBMISSION_ROOT / "data" / "processed" / "hard_test_pool_dataframe.pkl"
