...
from src.b_benchmark.column_category_map import canonicalize_property_name
from rdkit import Chem
from rdkit.Chem import SanitizeMol
try:
    from src.b_benchmark.natural_language.mappings import parse_natural_language
except ImportError:
    from b_benchmark.natural_language.mappings import parse_natural_language
except Exception as e:
    raise ImportError(f"Failed to import parse_natural_language: {e}")
