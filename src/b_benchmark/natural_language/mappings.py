...
from src.b_benchmark.column_category_map import KEY_ALIAS_MAP

# ============================================================================
# DYNAMIC LOADING FUNCTIONS
# ============================================================================

def load_functional_groups(base_path: Optional[Path] = None) -> Dict[str, str]:
    """Load functional groups from smarts_renamed.txt file."""
    groups: Dict[str, str] = {}
    directory = base_path or Path(__file__).parent
    file_path = directory / "smarts_renamed.txt"
...
def load_reaction_templates(base_path: Optional[Path] = None) -> Dict[str, str]:
    """Load reaction templates from reaction_templates.txt file."""
    reactions: Dict[str, str] = {}
    directory = base_path or Path(__file__).parent
    file_path = directory / "reaction_templates.txt"
