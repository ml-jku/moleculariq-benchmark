...
POOLS_DIR = REPO_ROOT / "data" / "dataset_pools"
PROPERTIES_DIR = REPO_ROOT / "data" / "benchmark"


@dataclass
class PropertyCreationConfig:
    input_path: Path = POOLS_DIR / "processed" / "hard_test_pool_dataframe.pkl"
    output_path: Path = PROPERTIES_DIR / "properties.pkl"

#---------------------------------------------------------------------------------------
# Imports
from src.b_benchmark.solver.solver import SymbolicSolver
from src.b_benchmark.task_names import task_names
